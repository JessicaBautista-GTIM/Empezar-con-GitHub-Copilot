...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["sam@mergington.edu", "lina@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Drama Club": {
        "description": "Practice acting and prepare for school theater performances",
    ...
    "Science Club": {
        "description": "Explore experiments and scientific concepts in a hands-on environment",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
